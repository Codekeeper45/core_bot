...
const definition = {
  ...
  function: {
    ...
    description:
      'Управление планировщиком отчётов (только режим БОССА). Планировщик сам шлёт утром сводку '
...
// Доступ боссу гарантирует code-level гейт BOSS_ONLY в tools/index.js (по context.role).
